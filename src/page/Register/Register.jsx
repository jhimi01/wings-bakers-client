...
const Register = () => {
  ...
  <hr className='my-3' />
        <div className="oauth-group flex flex-col gap-4">
          <button className="oauth-button flex items-center justify-center gap-3 text-gray-700">Sign in with Google <FaGoogle></FaGoogle></button>
          <button className="oauth-button  flex items-center justify-center gap-3 text-gray-700">Sign in with GitHub <FaGithub></FaGithub></button>
        </div>
      </form>
    );
}
